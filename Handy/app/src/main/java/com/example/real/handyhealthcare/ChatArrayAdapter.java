...
class ChatArrayAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatArrayAdapter(Context context, List<ChatMessage> data,ListView chatList) {
        ...
        //this.myDataset=myDataset;  //added by me bj
    }
    @Override
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (viewType==2 ) {
            ...
            TextView textView2 = (TextView) convertView.findViewById(R.id.textView2); // changed from textview2 to textview2r
            ...
            male.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    HMainActivity cont = (HMainActivity) context;
                    new HChat(cont).execute(cont.Authorization,jsn.toString());
        ...
        if (viewType==3 ) {
            ...
            yesgo= (Button) convertView.findViewById(R.id.card1btn1);
            ...
            nocorrect= (Button) convertView.findViewById(R.id.card1btn2);
        ...
        if(viewType==4){
            ...
            TextView textView2 = (TextView) convertView.findViewById(R.id.textView); // changsd from textview to textviewr
            textView2.setText(getItem(position).getMessage());
            // debugging area...................................................2

            nogo= (Button) convertView.findViewById(R.id.card2btn2);
            ...
            yesmore= (Button) convertView.findViewById(R.id.card2btn1);
        ...
        if(viewType==5){
            ...
            TextView textView2 = (TextView) convertView.findViewById(R.id.textView2p2);
            textView2.setText(getItem(position).getMessage());
            yes= (Button) convertView.findViewById(R.id.yesbtn1);
            ...
            no= (Button) convertView.findViewById(R.id.yesbtn2);
            ...
            donnu= (Button) convertView.findViewById(R.id.yesbtn3);
