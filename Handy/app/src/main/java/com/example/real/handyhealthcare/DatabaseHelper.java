...
public class DatabaseHelper extends SQLiteOpenHelper {
 ...
 private static final String DATABASE_NAME = "Handy_HealthCare.db";
...
//    this is password recovering region done by me

 public void updatePassword(String ou, String op) {
  SQLiteDatabase db1 = this.getWritableDatabase();
  ContentValues contentValues = new ContentValues();
  contentValues.put("password", op);
  db1.update(TABLE_NAME_USER, contentValues, "username=?", new String[]{ou});
  db1.close();
 ...
 // Cursor cursor=db1.query(TABLE_NAME_USER,columns,selection,selectionArgs);
